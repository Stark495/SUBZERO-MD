...
module.exports = {
    ...
    REPO: process.env.REPO || "https://github.com/Stark495/SUBZERO-MD",  // Bot's GitHub repo
    BAILEYS: process.env.BAILEYS || "@whiskeysockets/baileys",  // Bot's BAILEYS

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "237654765115",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Stark",           // Owner's name
    DEV: process.env.DEV || "237654765115",                     // Developer's contact number
    DEVELOPER_NUMBER: '237654765115@s.whatsapp.net',            // Developer's WhatsApp ID
